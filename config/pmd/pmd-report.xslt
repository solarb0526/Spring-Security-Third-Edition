        ...
        <html>
            ...
            <body>
                ...
                <xsl:for-each select="file">
                    ...
                    <H3>
                        <xsl:value-of disable-output-escaping="yes"
                                      select="substring-before(translate(@name,'/','.'),'.java')"/>
                    </H3>
                                ...
                                <td style="padding: 3px" align="right">
                                    <a>
                                        <xsl:attribute name="href">
                                            <xsl:value-of select="$cvsweb"/><xsl:value-of select="$filename"/>?annotate=HEAD#<xsl:value-of
                                                disable-output-escaping="yes" select="@beginline"/>
                                        </xsl:attribute>
                ...
                <p>Generated by
                    ...
                    on <xsl:value-of select="//pmd/@timestamp"/>.
                </p>
            </body>
        </html>
    </xsl:template>
